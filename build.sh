...
sed -i "s|https://XXXXXXXXXXXX.supabase.co|${SUPABASE_URL}|g" index.html # Substitui o
#placeholder da chave pela anon key real sed -i
sed -i "s|sb_publishable_1KCqMOPNbHtTrwV-o3F_KQ_PHqZ0AnL|${SUPABASE_ANON_KEY}|g" index.html echo 'Build
